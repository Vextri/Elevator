    ...
    <div class="container">
        <div class="alert">
            ...
            <?php if (!$mysql_status): ?>
                <div style="background: #f8d7da; color: #721c24; padding: 10px; border-radius: 5px; margin: 10px 0;">
                    <strong>MySQL Connection Issue Detected!</strong><br>
        ...
        <div class="grid">
            ...
            <div class="card setup-card">
                ...
                <a href="check_database_structure.php" class="button">Check Database Status</a>
                
                <hr style="margin: 15px 0;">
                <small><strong>Quick Start:</strong> Run MySQL diagnosis first to check connection</small>
            </div>
            ...
            <div class="card control-card">
                ...
                <a href="../html/login.html" class="button">Login System</a>
                <a href="index.php" class="button">Inside Control</a>
                <a href="../html/test_elevator.html" class="button">Elevator Interface</a>
                <a href="dashboard.php" class="button">Dashboard</a>
                
                <hr style="margin: 15px 0;">
                <!-- Default Login: Admin123 / Admin123! -->
            </div>
            ...
            <div class="card maintenance-card">
                ...
                <a href="../html/test_lockout_integration.html" class="button">Test Safety System</a>
                <a href="admin_lockout_debug.php" class="button">Debug Lockout System</a>
            ...
            <div class="card info-card">
                ...
                <a href="../html/request_access.html" class="button">Request Access</a>
                <a href="user_requests.php" class="button">View Requests</a>
                <a href="members1.php" class="button">Access Requests Management</a>
                <a href="members.php" class="button">Complete Database Management</a>
                
                <hr style="margin: 15px 0;">
                <small><strong>Note:</strong> Complete CRUD operations for all database tables</small>
            </div>
            ...
            <div class="card maintenance-card">
                ...
                <a href="exception_test.php" class="button">Exception Handling Test</a>
                <a href="../html/test_card_login.html" class="button">Test Card Reader</a>
                <a href="../diagnostics/diagnostics.php" class="button">Height Diagnostics</a>
            ...
            <div class="card info-card">
                ...
                <a href="documentation.php" class="button">Full Documentation</a>
                <a href="../html/deliverables.html" class="button">Project Details</a>
                <a href="../html/debug_status.html" class="button">Debug Info</a>
                <a href="../logbooks/" class="button">Project Logbooks</a>
        ...
        <div class="emergency-section">
            ...
            <div style="margin: 10px 0;">
                ...
                <a href="../MYSQL_FIX_GUIDE.md" class="button">MySQL Fix Guide</a>
                <small>(Check the guide for password reset steps)</small>
            </div>
            
            <div style="margin: 10px 0;">
                <strong>Alternative:</strong>
                <a href="http://localhost/phpmyadmin" target="_blank" class="button">Try phpMyAdmin</a>
        ...
        <div class="container" style="text-align: center; margin-top: 30px;">
            ...
            <?php if (!$database_status): ?>
                <a href="diagnose_mysql.php" class="button" style="font-size: 18px; padding: 15px 30px;">Start Here: Run Diagnostics</a>
            <?php else: ?>
                <a href="../html/login.html" class="button" style="font-size: 18px; padding: 15px 30px;">Login to System</a>
