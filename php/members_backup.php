<?php
/**
 * Members.php - Database Management Interface
 * Manages all database tables: requests, access_logs, users, and more
 */
    ...
    try {
        if (isset($_POST['action'])) {
            switch ($_POST['action']) {
                ...
                case 'update':
                    // Update existing record using transactions
                    $updates = [
                        'nodeName' => $_POST['nodeName'],
                        'nodeType' => $_POST['nodeType'],
                        'ipAddress' => $_POST['ipAddress'],
...
<body>
    <div class="container">
        ...
        <p><strong>Database Characteristics:</strong> Primary/Foreign Keys, Unique Constraints, Indexes, Update Functions, Transactions, CRUD Operations</p>
