...
public:
  ...
  uint32_t getTxdata();                         // Get the first byte of data from txdata array (per our protocol) - modify if you want to use more than first byte
  void setTxdata(byte, uint16_t);                     // Set the first byte of data from txdata array (per our protocol) - modify if you want to use more than first byte 
